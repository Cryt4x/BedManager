...
public class BurgerBudeCryT4xPluginInfoCommand implements CommandExecutor //implements Command class
{
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
	{
		...
		else if (sender instanceof ConsoleCommandSender) //When you use this command in console
		{
			...
			System.out.println("|| Website:     "+info[2]+" ||");
			System.out.println("|| Version:     "+info[3]+" ||");
			System.out.println("|| APIVersion:  "+info[1]+" ||");
			System.out.println("||              "+spacer(" ", infoL)+"||");
			System.out.println("\\\\=============="+spacer("=", infoL)+"//");
		}
		return false;
